package com.central.cms.commons.util;
...
public class ControllerUtil {
    ...
    /** 输出html */
    public static void renderHtml(StringBuffer content) {
    ...
    /** 下载文件 */
    public static void downFile(HttpServletResponse response,HttpServletRequest request,File file, String fileName, boolean isDelete) throws ApiException {
        if(!file.exists()) throw new ApiException("文件不存在！");
        try {
            response.reset();
